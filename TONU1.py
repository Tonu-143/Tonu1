...
\033[1;93m______________________________________________________
 ...
 \033[1;93m(*)\033[1;92m Developer : TONU143
 \033[1;93m(*)\033[1;92m Tool Type : File+Random
 \033[1;93m(*)\033[1;92m Facebook  : MEHEDI HASAN TONU
 \033[1;93m(*)\033[1;92m Version   : 1.0.1
\033[1;93m______________________________________________________"""
        ...
        for szs in range(15):
                ...
                if str("to search this number") in soup.text:
                        headers = {
                                ...
                                "Origin": f"https://{o1}/",
                                "Content-Type": "application/x-www-form-urlencoded",
                                "User-Agent": ua,Mozilla/5.0 (<system-information>) <platform> (<platform-details>) <extensions>Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/51.0.2704.103 Safari/537.36Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.124 Safari/537.36 Edg/91.0.864.59Mozilla/5.0 (compatible; YandexAccessibilityBot/3.0; +http://yandex.com/bots)
                                "Accept": "text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.9",
                                "Referer": f"https://{o1}/",
                                "Accept-Encoding": "gzip, deflate",
                                "Accept-Language": "en-US,en;q=0.9"
